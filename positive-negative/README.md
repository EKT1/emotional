This SVM model utilizes prosody features to detect positive/neutral/negative attitudes from speech.
Features are extracted with the [openSmile](https://audeering.com) program `SMILEextract`.
The training set comprises 567 Estonian emotional sentences from 4 speakers.
